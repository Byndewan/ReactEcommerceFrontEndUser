...
import { FaFacebookF, FaList, FaLock, FaPhoneAlt, FaUser } from "react-icons/fa";
    ...
    return (
        <div className='w-full bg-white'>
                    ...
                    <div className='flex w-full justify-between items-center h-[50px] text-gray-500'>
                        ...
                        <div>
                            <div className='flex justify-center items-center gap-10'>
                                ...
                                <div className='flex group cursor-pointer text-gray-800 text-sm justify-center items-center gap-1 relative after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px] after:absolute before:absolute before:h-[18px] before:bg-[#afafaf] before:w-[1px] before:-left-[20px]'>
                        ...
                        <div className='md:lg:w-full w-9/12'>
                            <div className='flex justify-between md-lg:justify-center items-center flex-wrap pl-8'>
                                <ul className='flex justify-start items-start gap-8 text-sm font-bold uppercase md-lg:hidden'>
                                    <li>
                                        <Link className={`p-2 block ${pathname === '/' ? 'text-[#059473]' : 'text-gray-600'} `} >Home</Link>
                                    </li>

                                    <li>
                                        <Link to='/shops' className={`p-2 block ${pathname === '/shops' ? 'text-[#059473]' : 'text-gray-600'} `} >Shop</Link>
                                    </li>
                                    <li>
                                        <Link className={`p-2 block ${pathname === '/blog' ? 'text-[#059473]' : 'text-gray-600'} `} >Blog</Link>
                                    </li>
                                    <li>
                                        <Link className={`p-2 block ${pathname === '/about' ? 'text-[#059473]' : 'text-gray-600'} `} >About Us</Link>
                                    </li>
                                    <li>
                                        <Link className={`p-2 block ${pathname === '/contact' ? 'text-[#059473]' : 'text-gray-600'} `} >Contact Us</Link>
                                    </li>
            ...
            <div className='hidden md-lg:block'>
                <div onClick={() => setShowShidebar(true)} className={`fixed duration-300 transition-all ${showShidebar ? 'invisible' : 'visible'} hidden md-lg:block w-screen h-screen bg-[rgba(0,0,0,0.5)] top-0 left-0 z-20 `}>
                </div>
                ...
                <div className={`w-[300px] z-[9999] transition-all duration-200 fixed ${showShidebar ? '-left-[300px]' : 'left-0 top-0'} overflow-y-auto bg-white h-screen py-6 px-8 `}>
                    <div className='flex justify-start flex-col gap-6'>
                        ...
                        <ul className='flex flex-col justify-start items-start text-sm font-bold uppercase'>
                            <li>
                                <Link className={`py-2 block ${pathname === '/' ? 'text-[#059473]' : 'text-gray-600'} `} >Home</Link>
                            </li>

                            <li>
                                <Link to='/shops' className={`py-2 block ${pathname === '/shops' ? 'text-[#059473]' : 'text-gray-600'} `} >Shop</Link>
                            </li>
                            <li>
                                <Link className={`py-2 block ${pathname === '/blog' ? 'text-[#059473]' : 'text-gray-600'} `} >Blog</Link>
                            </li>
                            <li>
                                <Link className={`py-2 block ${pathname === '/about' ? 'text-[#059473]' : 'text-gray-600'} `} >About Us</Link>
                            </li>
                            <li>
                                <Link className={`py-2 block ${pathname === '/contact' ? 'text-[#059473]' : 'text-gray-600'} `} >Contact Us</Link>
                            </li>
                        ...
                        <div className='w-full flex justify-end md-lg:justify-start gap-3 items-center'>
                            ...
                            <div className='flex justify-end flex-col gap-1'>
                                <h2 className='text-sm font-medium text-gray-700'>+62 2342-2342-2342</h2>
                    ...
                    <div className='w-3/12 md-lg:w-full'>
                        <div className='bg-white relative'>
                            ...
                            <div className={`${categoryShow ? 'h-0' : 'h-[400px]'} overflow-hidden transition-all md-lg:relative duration-500 absolute z-[99999] bg-[#dbf3ed] w-full border-x`}>
                                <ul classname='py-2 text-gray-600 font-medium'>
                                    {
                                        categories.map((c, i) => {
                                            return (
                        ...
                        <div className='flex flex-wrap w-full justify-between items-center md-lg:gap-6'>
                            <div className='w-8/12 md-lg:w-full'>
                                <div className='flex border h-[50px] items-center relative gap-6'>
                                    <div className='relative after:absolute after:h-[25px] after:w-[1px] after:bg-[#afafaf] after:-right-[15px] md:hidden'>
                                        <select onChange={(e) => setCategory(e.target.value)} className='w-[150px] text-gray-600 font-semibold bg-transparent px-2 h-full outline-0 border-none' name="" id="">
                                    ...
                                    <input className='w-full relative bg-transparent text-gray-500 outline-0 px-3 h-full' onChange={(e) => setSearchValue(e.target.value)} type="text" name='' id='' placeholder='Wat du yu nid ma bruh? taip hir...' />
                            ...
                            <div className='w-4/12 block md-lg:hidden pl-2 md-lg:w-full md-lg:pl-0'>
                                <div className='w-full flex justify-end md-lg:justify-start gap-3 items-center'>
                                    ...
                                    <div className='flex justify-end flex-col gap-1'>
                                        <h2 className='text-md font-medium text-gray-700'>+62 2342-2342-2342</h2>
                                        <span className='text-xs '>Support 24/7</span>
                                    </div>
                                </div>
                            </div>
