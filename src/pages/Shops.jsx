                ...
                <div className='absolute left-0 top-0 w-full h-full bg-[#2422228a]'>
                    <div className='w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto'>
                        <div className='flex flex-col justify-center items-center gap-1 h-full w-full text-white'>
                            <h2 className='text-3xl font-bold'>Shop Pages</h2>
...
<button onClick={() => setFilter(!filter)} className='text-center w-full py-2 px-3 bg-[#059473]  text-white'>Filter Product</button>
</div>
...
<h2 className='text-3xl font-bold mb-3 text-gray-600'>Category</h2>
<div className='py-2'>
{
categories.map((c,i) => 
<div className='flex justify-start items-center gap-2 py-1'>
<input type="checkbox" name={c} id={c} />
<label className='text-gray-600 block cursor-pointer' htmlFor={c} >{c}</label>
</div>
)
}
</div>
